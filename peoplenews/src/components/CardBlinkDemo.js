      ...
      <Card className=" m-0 w-100">
        <Card.Content>
          <Image
            className="card-img"
            floated="left"
            src={props.item.owner.image}
          />
          <Card.Header
            className="hover"
            onClick={() => handleUserBlinks(props.item.owner._id)}
          >
          ...
          >
            ...
            <div className={`${singleBlinkClass} deleteText `}>
              ...
              <p>Edit</p>
              <p onClick={() => handleDelete(props.item._id)}>Delete</p>
            </div>
          </Card.Description>
          ...
          <div className="d-flex justify-content-between">
            <div className="d-flex justify-content-between">
              ...
              <span
                style={{
                  cursor: "pointer",
                  color: props.item.likes.includes(userData._id)
                    ? "red"
                    : "black",
                }}
            ...
            <div><small>Comments: 0</small>   </div>         
          </div>
        </Card.Content>
      </Card>
